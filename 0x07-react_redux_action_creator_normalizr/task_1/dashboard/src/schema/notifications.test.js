...
const { normalizedData } = require('./notifications');
...
describe('normalizedData', () => {
  ...
  it('should have a correct users entity for user id 5debd764a7c57c7839d722e9', () => {
  ...
  it('should have a correct messages entity for guid efb6c485-00f7-4fdf-97cc-5e12d14d6c41', () => {
  ...
  it('should have a correct notifications entity for id 5debd7642e815cd350407777', () => {
